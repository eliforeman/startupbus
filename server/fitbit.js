...
const getFitBitUpdate = axios.get('https://api.fitbit.com/1/user/-/activities/distance/date/today/1d/15min.json').then((res) => {
  return res.data["activities-distance"][0].value;
})
.catch((error) => {
console.error(error)
})
